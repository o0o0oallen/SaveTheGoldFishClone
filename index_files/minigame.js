! function (e, t) {
	...
	class te extends ee {
		...
		loadAsync() {
			return c(this, void 0, void 0, function* () {
				...
				try {
					...
					this._state = a.NEW, t = 10 * this._errorCounter + 1,
					console.log("Reload after " + t + " seconds: " + this.getInfo()),
					this.safeReLoadAsync(t)), e
				}
			})
		}
		isReady() {
		...
		showAsync() {
			return c(this, void 0, void 0, function* () {
				if (!this.isReady()) throw console.log("Not Ready for play: " + this.getInfo()),
	...
	class o {
		...
		static loadAllAsync() {
			return c(this, void 0, void 0, function* () {
				console.log("co load vao day ko?")
